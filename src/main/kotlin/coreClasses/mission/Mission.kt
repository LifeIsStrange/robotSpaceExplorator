        ...
        if (Utils.getRandomNumberInRange(0f, 100f) <= 10f) {
            GlobalScope.launch {
                missionNetworkService.sendMessage(
                    messageContent = "stage transition failed",
            ...
            if (Utils.getRandomNumberInRange(0f, 100f) > 25f) {
                ...
                throw Exception("Mission abort, update non successfull")
            } else {
                GlobalScope.launch {
                    missionNetworkService.sendMessage(
                        messageContent = "Mission has sucessfully recovered from the software update",
